...
<head>
    ...
    <link href="/template/dist/css/custom.css" rel="stylesheet">
    <!-- This page CSS -->
    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center"
            ...
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        <span class="db"><img src="/template/assets/images/logo.jpeg" style="width: 20%;"
                                alt="logo" /></span>
                    ...
                    <div class="row">
                        <form class="col s12" method="POST" action="/login">
                            ...
                            <div class="row m-t-40">
                                <div class="col s12">
                                    <button class="btn-large w100 primary" type="submit">Login</button>
                                </div>
                            </div>
                        </form>
                    </div>
