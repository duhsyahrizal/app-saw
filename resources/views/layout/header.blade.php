  ...
  <nav data-navbarbg="skin1">
    <div class="nav-wrapper">
      ...
      <ul class="right">
        ...
        <!-- ============================================================== -->
        <li><a class="dropdown-trigger" href="javascript: void(0);" data-target="user_dropdown"><img src="/template/assets/images/users/2.jpg" alt="user" class="circle profile-pic"></a>
...
=======
    ...
    <!-- Navbar scss in header.scss -->
    <!-- ============================================================== -->
>>>>>>> d33079d8045fcad44b2b5f8b135fa45aef514829
</header>
